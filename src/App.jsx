...
const AppRoutes = () => {
  ...
  const hideSidebar = hideSidebarRoutes.some((route) =>
    isValidRoute(route, location.pathname)
  );
  const isValidRoutes = routesArray.some((route) =>
    isValidRoute(route, location.pathname)
  );
          ...
          <>
            ...
            {hideSidebar ? (
              <Routes>
                ...
                />
                <Route
                  path="/producerdetailpage/:id"
                  element={<ProducerDetailPage />}
                />
                <Route
                  path="/tokendetailpage/:id"
                ...
                <Routes>
                  ...
                  <Route path="/data">
                    ...
                    <Route path="poxsupply">
                      ...
                      <Route
                        path="pox/poxmarketcap"
                        element={<PoxMarketCap />}
                      />
                      <Route
                        path="pox/poxgenerated/burned"
                        element={<PoxGenerated />}
                      />
                      <Route path="pox/poxstaked" element={<PoxStaked />} />
                      <Route path="network" element={<Network />} />
                      <Route
                        path="network/protocolrevenue"
                        element={<ProtocolRevenue />}
                      />
                      <Route
                        path="network/energyconsumption"
                        element={<EnergyConsumption />}
                      />
                      <Route
                        path="network/bandwidthconsumption"
                        element={<BandwidthConsumption />}
                      />
                      <Route
                        path="network/resourcecosts"
                        element={<ResourceCosts />}
                      />
                      <Route
                        path="network/averageblocksize"
                        element={<AverageBlockSize />}
                      />
                      <Route
                        path="network/on-chaindatasize"
                        element={<OnchainDataSize />}
                      />
                      <Route
                        path="network/real-timeblockproduction"
                        element={<RealtimeBlockProduction />}
                      />
                      <Route
                        path="network/srvotesdistribution"
                        element={<SrVotesDistribution />}
                      />
                      <Route path="accounts" element={<Account />} />
                      <Route
                        path="accounts/totalaccounts"
                        element={<TotalAccounts />}
                      />
                      <Route
                        path="accounts/activeaccounts"
                        element={<ActiveAccounts />}
                      />
                      <Route
                        path="accounts/newaccounts"
                        element={<NewAccounts />}
                      />
                      <Route
                        path="accounts/poxholders"
                        element={<PoxHolders />}
                      />
                      <Route path="transactions" element={<Transaction1 />} />
                      <Route
                        path="transactions/transactiontrend"
                        element={<TransactionTrend />}
                      />
                      <Route
                        path="transactions/cumulativetransactions"
                        element={<CumulativeTransactions />}
                      />
                      <Route path="contracts" element={<Contracts />} />
                      <Route
                        path="contracts/contractcalls"
                        element={<ContractCalls />}
                      />
                      <Route
                        path="contracts/topcontracts"
                        element={<TopContracts />}
                      />
                    </Route>
                  ...
                  <Route path="/governance">
                    ...
                    <Route
                      path="superrepresentatives"
                      element={<SuperRepresentatives />}
                    />
                    <Route
                      path="parametersproposals"
                      element={<ParametersProposals />}
                    />
                    <Route
                      path="poxstakinggovernance"
                      element={<PoxStakingGovernance />}
                    />
                  ...
                  <Route path="/poxecosystem">
                    ...
                    <Route
                      path="contractsdeployment"
                      element={<ContractsDeployment />}
                    />
                    <Route
                      path="contractsverification"
                      element={<ContractsVerification />}
                    />
                    <Route
                      path="encodingconverter"
                      element={<EncodingConverter />}
                    />
                    <Route
