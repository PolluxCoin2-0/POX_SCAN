...
const StackedAreaChart = ({value, xAxis, yAxis, componentChartColor}) => {
  ...
  return (
    <ResponsiveContainer width="100%" height="100%">
      ...
      >
        ...
        <YAxis />
        <Tooltip />
        <Area type="monotone" dataKey={yAxis} stackId="1" stroke={componentChartColor} fill={`url(#colorGradient${componentChartColor})`} />
