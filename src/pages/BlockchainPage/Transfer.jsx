  ...
  return (
    <div className="px-12 pb-12">
      ...
      <div className="flex flex-row justify-start gap-8 pt-20 pb-10">
        <button className={`cursor-pointer py-3 px-4 whitespace-nowrap  ${isRender === "POX20 Transfers" ? "bg-dark-yellow  shadow-lg rounded-lg" : "text-black bg-text-bg-gray shadow-md rounded-lg"}`}
         onClick={() => setIsRender("POX20 Transfers")}>
          POX20 Transfers
        </button>
        <button className={`cursor-pointer py-3 px-4 whitespace-nowrap ${isRender === "POX721 Transfers" ? "bg-dark-yellow  shadow-lg rounded-lg" : "text-black bg-text-bg-gray shadow-md rounded-lg"}`}
         onClick={() => setIsRender("POX721 Transfers")}>
          POX721 Transfers
        </button>

        <button className={`cursor-pointer py-3 px-4 whitespace-nowrap ${isRender === "POX Transfers" ? "bg-dark-yellow shadow-lg rounded-lg" : "text-black bg-text-bg-gray shadow-md rounded-lg"}`}
         onClick={() => setIsRender("POX Transfers")}>
          POX Transfers
        </button>

        <button className={`cursor-pointer py-3 px-4 whitespace-nowrap ${isRender === "POX1155 Transfers" ? "bg-dark-yellow shadow-lg rounded-lg" : "text-black bg-text-bg-gray shadow-md rounded-lg"}`}
