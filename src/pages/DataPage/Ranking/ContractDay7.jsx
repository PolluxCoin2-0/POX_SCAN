...
import { getRankingContractDaySevenData, getRankingContractDayThreeData } from "../../../utils/axios/Data";
...
const TableData = ({title, tableDataArray, type}) => {
    ...
    useEffect(() => {
      ...
      const fetchData = async () => {
        try {
          const data = await getRankingContractDaySevenData();
          console.log(data);
          setData(data);
