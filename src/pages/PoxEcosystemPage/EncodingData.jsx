    ...
    <div className="bg-white pt-2 pb-40 rounded-lg">
      <div className="flex flex-row justify-around pt-14 items-center">
        ...
        <div className="flex flex-col ">
          <button className="bg-dark-yellow py-2 px-16 font-bold rounded-lg  text-black cursor-pointer mt-14 ">
            {" "}
            Convert{" "}
          </button>
          <MdArrowRightAlt className="ml-36 -mt-8 mr-12" size={28} />

          <button className="bg-white py-2  font-bold rounded-lg text-black border-2 cursor-pointer mt-5 ">
            {" "}
            Convert{" "}
          </button>
          <HiMiniArrowLongLeft className="-mt-8 ml-12" size={24} />

          <button className="bg-white py-2 px-16 font-bold rounded-lg text-black border-2 cursor-pointer mt-5  ">
            {" "}
            Reset{" "}
          </button>
        </div>
  ...
  return (
    <div>
      ...
      <div className=" rounded-lg pb-48">
        <div className="flex flex-col lg:flex-row xl:flex-row 2xl:flex-row space-x-12 pt-12">
          <p
            className={`cursor-pointer py-3 px-4 whitespace-nowrap ${
              isRender === "Pollux- EVM Address"
                ? "bg-white font-bold  rounded-t-2xl"
                : "text-light-gray"
            }`}
          ...
          <p
            className={`cursor-pointer py-3 px-4 whitespace-nowrap ${
              isRender === "Base58 Check Encode / Decode"
                ? "bg-white font-bold rounded-t-2xl"
                : "text-light-gray"
            }`}
          ...
          <p
            className={`cursor-pointer py-3 px-4 whitespace-nowrap ${
              isRender === "Private Key - Public Key & Address"
                ? "bg-white font-bold  rounded-t-2xl"
                : "text-light-gray"
            }`}
