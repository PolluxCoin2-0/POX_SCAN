  ...
  return (
    <div className="bg-white p-5 pl-5 pr-5 rounded-xl shadow-xl">
      ...
      <div className="min-w-[1500px]  flex flex-row justify-around p-2 bg-lightest-gray rounded-lg ">
        ...
        <p className=" w-[13%] text-center font-bold whitespace-nowrap">From</p>
          ...
          return (
            <div key={index}>
              <div className="min-w-[1500px]  flex flex-row  justify-around border-b-2 p-4 border-text-bg-gray">
                ...
                <p className=" w-[12%] text-center">{stablecoin?.assetName}</p>
    ...
    <div>
      <div className="bg-white p-5 rounded-xl shadow-lg mb-10">
        ...
        <div className=" flex flex-row w-full  border-white  rounded-md mt-5 h-[20px]">
          <p className="bg-pink-gradient w-[34%] text-dark-pink rounded-tl-md rounded-bl-md  ">
            .
          </p>
        ...
        <div className="flex flex-row justify-between mt-5">
          <div className="flex flex-row items-center space-x-2">
            ...
            <p className="text-sm font-semibold">
              {sliderdata?.rangeData?.[0]?.range}:{" "}
              {sliderdata?.rangeData?.[0]?.percentage}
            </p>
          </div>
          ...
          <div className="flex flex-row items-center space-x-2">
            ...
            <p className="text-sm font-semibold">
              {sliderdata?.rangeData?.[1]?.range}:{" "}
              {sliderdata?.rangeData?.[1]?.percentage}
            </p>
          </div>
          ...
          <div className="flex flex-row items-center space-x-2">
            ...
            <p className="text-sm font-semibold">
              {sliderdata?.rangeData?.[2]?.range}:{" "}
              {sliderdata?.rangeData?.[2]?.percentage}
            </p>
          </div>
          ...
          <div className="flex flex-row items-center space-x-2">
            ...
            <p className="text-sm font-semibold">
              {sliderdata?.rangeData?.[3]?.range}:{" "}
              {sliderdata?.rangeData?.[3]?.percentage}
            </p>
          </div>
          ...
          <div className="flex flex-row items-center space-x-2">
            ...
            <p className="text-sm font-semibold">
              {sliderdata?.rangeData?.[4]?.range}:{" "}
              {sliderdata?.rangeData?.[4]?.percentage}
            </p>
          </div>
        </div>
      </div>
      <div className="bg-white p-5 pl-5 pr-5 rounded-xl shadow-xl">
        ...
        <div className="flex flex-row justify-evenly p-2 bg-lightest-gray rounded-lg ">
          ...
          <p className="w-[15%]  text-center font-bold ">
      ...
      <div className=" flex flex-col space-x-5 md:flex-row justify-between">
        ...
        <div className="w-full md:w-[30%]  bg-white shadow-lg rounded-2xl p-5 my-6 md:my-12">
          <div className="pt-1 flex flex-row justify-between">
            ...
            <p className="text-dark-green bg-light-green rounded-md px-6 font-bold ">
              Reputation: {poxData?.Rep}{" "}
            </p>
          </div>

          <div className="flex flex-row space-x-2 pt-3">
            <p className="font-semibold">
              {poxData?.price && poxData?.price} USDX
            </p>
          ...
          <div className="flex flex-row justify-between pt-7 pb-4 border-b-[1px] border-text-bg-gray">
            ...
            <p>
              {poxData?.totalsupply &&
                formatNumberWithCommas(Number(poxData?.totalsupply).toFixed(3))}
            </p>
          </div>
          ...
          <div className="flex flex-row justify-between pt-4 pb-4 border-b-[1px] border-text-bg-gray">
            ...
            <p>
              {poxData?.maxSupply &&
                formatNumberWithCommas(Number(poxData?.maxSupply).toFixed(0))}
            </p>
          </div>
          ...
          <div className="flex flex-row justify-between pt-4 pb-4 border-b-[1px] border-text-bg-gray">
            ...
            <p>
              {poxData?.circsupply &&
                formatNumberWithCommas(Number(poxData?.circsupply).toFixed(3))}
            </p>
          </div>
          ...
          <div className="flex flex-row justify-between pt-4 pb-4 border-b-[1px] border-text-bg-gray">
            ...
            <p>
              {poxData?.totalmatket &&
                formatNumberWithCommas(Number(poxData?.totalmatket).toFixed(3))}
            </p>
          </div>
          ...
          <div className="flex flex-row justify-between pt-4 ">
            ...
            <p>
              {poxData?.circmarket &&
                formatNumberWithCommas(Number(poxData?.circmarket).toFixed(3))}
            </p>
          </div>
        </div>
        ...
        <div className="w-full md:w-[40%]  rounded-2xl p-5 bg-white shadow-md my-3 md:my-12">
          ...
          <div className="flex flex-row justify-between pt-14 pb-4 border-b-[1px] border-text-bg-gray">
            ...
            <div className="flex flex-row space-x-1">
              ...
              <p className="pt-1">
                <RiFileCopy2Fill
                  onClick={() => handleCopy(poxData?.contractAddress)}
                />
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-row justify-between pt-4 pb-4 border-b-[1px] border-text-bg-gray">
            ...
            <div className="flex flex-row space-x-1">
              ...
              <p className="pt-1">
                <RiFileCopy2Fill onClick={() => handleCopy(poxData?.issuer)} />
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-row justify-between  pt-4 pb-4 border-b-[1px] border-text-bg-gray">
            ...
            <p className="text-dark-red underline">
              {" "}
              {poxData?.Web && poxData?.Web}
            </p>
          </div>
          ...
          <div className="flex flex-row justify-between  pt-4 pb-4 border-b-[1px] border-text-bg-gray">
            ...
            <p className="text-dark-red underline">
              {poxData?.Whitepaper && poxData?.Whitepaper}
            </p>
          </div>
          ...
          <div className="flex flex-row justify-between  pt-4  ">
            ...
            <div className="flex flex-row space-x-3">
              ...
              <Link to={poxData?.social?.fb} className="cursor-pointer">
                <p>
                  <PiFacebookLogoLight size={20} color="#C23631" />{" "}
                </p>
              </Link>

              <Link to={poxData?.social?.insta} className="cursor-pointer">
                <p>
                  <PiInstagramLogoLight size={20} color="#C23631" />{" "}
                </p>
              </Link>
              ...
              <Link to={poxData?.social?.tele} className="cursor-pointer">
                <p>
                  {" "}
                  <LiaTelegram size={20} color="#C23631" />{" "}
                </p>
              </Link>
        ...
        <div className="w-full md:w-[30%] rounded-2xl p-5 bg-white shadow-md my-3 md:my-12">
          ...
          <div className="flex flex-row justify-between pt-14 pb-4 border-b-[1px] border-text-bg-gray">
            ...
            <p>
              {poxData?.holders && formatNumberWithCommas(poxData?.holders)}
            </p>
          </div>
          ...
          <div className="flex flex-row justify-between pt-4 pb-4 border-b-[1px] border-text-bg-gray">
            ...
            <p>
              {poxData?.totaltransfer &&
                formatNumberWithCommas(poxData?.totaltransfer)}
            </p>
          </div>
          ...
          <div className="flex flex-row justify-between pt-4 pb-4 border-b-[1px] border-text-bg-gray">
            ...
            <p>
              {poxData?.last24transfer &&
                formatNumberWithCommas(poxData?.last24transfer)}
            </p>
          </div>
          ...
          <div className="flex flex-row justify-between pt-4">
            ...
            <p>
              $
              {poxData?.tradingvol &&
                formatNumberWithCommas(Number(poxData?.tradingvol).toFixed(2))}
            </p>
          </div>
        </div>
      </div>
