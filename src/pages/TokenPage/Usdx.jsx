            ...
            <>
              <div className="min-w-[1500px]  flex flex-row  justify-around border-b-2 p-4 border-text-bg-gray">
                ...
                <p className=" w-[8%] flex justify-center">
                  {stablecoin?.result && stablecoin?.result ? (
                ...
                <p className="w-[14%] text-center ">
                  {secondsAgo(stablecoin?.timeStamp)}
                </p>

                <Link
                  to={`/accountdetails/${stablecoin?.fromAddress}`}
                  className="w-[19%] text-center text-dark-red "
                >
                  <p>
                    {stablecoin?.fromAddress &&
                      shortenString(stablecoin?.fromAddress, 8)}
                  </p>
                </Link>
                ...
                >
                  <p>
                    {stablecoin?.toAddress &&
                      shortenString(stablecoin?.toAddress, 8)}
                  </p>
                </Link>
                ...
                <Link
                  ...
                  className="w-[8%] text-center  text-dark-red"
                >
    ...
    <div>
      <div className="bg-white p-5 rounded-xl shadow-lg mb-10">
        ...
        <div className=" flex flex-row w-full  border-white  rounded-md mt-5 h-[20px]">
          <p className="bg-pink-gradient w-[57%] text-dark-pink rounded-tl-md rounded-bl-md  ">
            .
          </p>
        ...
        <div className="flex flex-row justify-between mt-5">
          <div className="flex flex-row items-center space-x-1">
            ...
            <p className="text-xs font-semibold">
              {sliderdata?.[0]?.range}: {sliderdata?.[0]?.percentage}
            </p>
          </div>
          ...
          <div className="flex flex-row items-center space-x-1">
            ...
            <p className="text-xs font-semibold">
              {sliderdata?.[1]?.range}: {sliderdata?.[1]?.percentage}
            </p>
          </div>
          ...
          <div className="flex flex-row items-center space-x-1">
            ...
            <p className="text-xs font-semibold">
              {sliderdata?.[2]?.range}: {sliderdata?.[2]?.percentage}
            </p>
          </div>
          ...
          <div className="flex flex-row items-center space-x-1">
            ...
            <p className="text-xs font-semibold">
              {sliderdata?.[3]?.range}: {sliderdata?.[3]?.percentage}
            </p>
          </div>
          ...
          <div className="flex flex-row items-center space-x-1">
            ...
            <p className="text-xs font-semibold">
              {sliderdata?.[4]?.range}: {sliderdata?.[4]?.percentage}
            </p>
          </div>
        </div>
      </div>
      <div className="bg-white rounded-xl shadow-lg p-5">
        <div className="bg-white rounded-2xl  md:p-7 ">
          <div className="overflow-x-auto">
            <p className="font-medium text-light-gray">
              Only the first{" "}
              <span className="text-black font-semibold">10,000</span> records
              are displayed
            </p>
          </div>
        </div>
        ...
        {holderdata?.holders?.map &&
          holderdata?.holders?.map((stablecoin, index) => {
            return (
              <div
                key={index}
                className="min-w-[1500px] flex flex-row justify-around border-b-2 p-4 border-text-bg-gray"
              >
                <p className="w-[8%] text-center ">{index + 1}</p>

                <Link
                  to={`/accountdetails/${stablecoin?.walletAddress}`}
                  className="w-[28%]   text-center  text-dark-red"
                  text-center
                >
                ...
                <p className="w-[16%]  text-center  ">
                  ${Number(stablecoin?.balance).toFixed(2)}
                </p>
                <p className="w-[12%]   text-center ">
                  {stablecoin?.percentage}%
                </p>
                <p className="w-[16%]  text-center ">
                  {secondsAgo(stablecoin?.updatedAt)}
                </p>
              </div>
            );
          })}
    ...
    <div className="px-4 md:px-12 pb-12">
      ...
      <div className="flex flex-row justify-between ">
        <div className="flex flex-row space-x-4">
          <div className="mt-2">
            <img src={UsdxImg} alt="pox image" className="w-[70px] " />
          </div>
          <div className="flex flex-col items-start ">
            <p className="font-bold text-xl">Pollux USD (USDX)</p>
            <p className="text-light-mid-gray text-sm border-[1px] border-light-mid-gray rounded-2xl  px-2 mt-1">
              PRC 20
            </p>
            <p className="pt-1">
              USDX is the official stablecoin issued by pollux on the POX
              network.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-row space-x-5 items-center">
          <div className="flex items-center space-x-4 font-bold bg-dark-yellow py-2 px-6 rounded-lg cursor-pointer">
            <button>Stake USDX to Get Rewards</button>
          </div>
      ...
      <div className=" flex flex-col space-x-5 md:flex-row justify-between">
        ...
        <div className="w-full md:w-[30%]  bg-white shadow-lg rounded-2xl p-5 my-6 md:my-12">
          <div className="pt-1 flex flex-row justify-between">
            ...
            <p className="text-dark-green bg-light-green rounded-md px-6 font-bold ">
              Reputation: OK{" "}
            </p>
          </div>
          ...
          <div className="flex flex-row space-x-2 pt-3">
            <p className="font-semibold">
              {usdxData?.totalSupply &&
                formatNumberWithCommas(
                  Number(usdxData?.totalSupply).toFixed(3)
                )}{" "}
              USDX
            </p>
          ...
          <p className="text-sm text-light-mid-gray">
            ≈$
            {usdxData?.totalSupply &&
              formatNumberWithCommas(Number(usdxData?.totalSupply).toFixed(3))}
          </p>
          ...
          <div className="flex flex-row justify-between pt-4 pb-4 border-b-[1px] border-text-bg-gray">
            ...
            <p>
              {usdxData?.circulationSupply &&
                formatNumberWithCommas(
                  Number(usdxData?.circulationSupply).toFixed(3)
                )}
            </p>
          </div>
          ...
          <div className="flex flex-row justify-between pt-4 pb-4 border-b-[1px] border-text-bg-gray">
            ...
            <p>
              {usdxData?.totalMarketCap &&
                formatNumberWithCommas(
                  Number(usdxData?.totalMarketCap).toFixed(3)
                )}
            </p>
          </div>
          ...
          <div className="flex flex-row justify-between pt-4 ">
            ...
            <p>
              {usdxData?.circulatingMarketCap &&
                formatNumberWithCommas(
                  Number(usdxData?.circulatingMarketCap).toFixed(3)
                )}
            </p>
          </div>
        </div>
        ...
        <div className="w-full md:w-[40%]  rounded-2xl p-5 bg-white shadow-md my-3 md:my-12">
          ...
          <div className="flex flex-row justify-between pt-14 pb-4 border-b-[1px] border-text-bg-gray">
            ...
            <div className="flex flex-row space-x-1">
              <Link
                to={`/tokendetailpage/${usdxData?.contractAddress}`}
              ...
              <p className="pt-1">
                <RiFileCopy2Fill
                  onClick={() => handleCopy(usdxData?.contractAddress)}
                />
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-row justify-between pt-4 pb-4 border-b-[1px] border-text-bg-gray">
            ...
            <div className="flex flex-row space-x-1">
              <Link
                to={`/accountdetails/${usdxData?.issuer}`}
                className="text-dark-red"
              >
              ...
              <p className="pt-1">
                <RiFileCopy2Fill onClick={() => handleCopy(usdxData?.issuer)} />
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-row justify-between  pt-4 pb-4 border-b-[1px] border-text-bg-gray">
            ...
            <p className="">
              {" "}
              {usdxData?.issuingTime && usdxData?.issuingTime}(UTC)
            </p>
          </div>
          ...
          <div className="flex flex-row justify-between  pt-4  ">
            ...
            <div className="flex flex-row space-x-3">
              <Link>
                <p>
                  <PiTwitterLogoLight size={20} color="#C23631" />
                </p>
              </Link>
            </div>
          </div>
        ...
        <div className="w-full md:w-[30%] rounded-2xl p-5 bg-white shadow-md my-3 md:my-12">
          <div className="pt-1 flex flex-row justify-between items-center">
            ...
            <p className="border-2 rounded-lg p-1 ">
          ...
          <div className="flex flex-row justify-between pt-14 pb-4 border-b-[1px] border-text-bg-gray">
            ...
            <p>
              {usdxData?.totalHolders &&
                formatNumberWithCommas(usdxData?.totalHolders)}
            </p>
          </div>
          ...
          <div className="flex flex-row justify-between pt-4 pb-4 border-b-[1px] border-text-bg-gray">
            ...
            <p>
              {usdxData?.totaltransferCount &&
                formatNumberWithCommas(usdxData?.totaltransferCount)}
            </p>
          </div>
          ...
          <div className="flex flex-row justify-between pt-4 pb-4 border-b-[1px] border-text-bg-gray">
            ...
            <p>
              {usdxData?.transfer24H &&
                formatNumberWithCommas(usdxData?.transfer24H)}
            </p>
          </div>
          ...
          <div className="flex flex-row justify-between pt-4">
            ...
            <p>
              $
              {usdxData?.tradingVolume &&
                formatNumberWithCommas(
                  Number(usdxData?.tradingVolume).toFixed(2)
                )}
            </p>
          </div>
        </div>
      ...
      <div className="flex flex-row space-x-8 pb-10">
        ...
        <p
          ...
          onClick={() => setIsRender("Token Holders")}
        >
          Token Holders
        </p>
      </div>
