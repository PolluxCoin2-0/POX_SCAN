...
export const getPoxSupplyTableData = async () => {
  try {
    const response = await axios.get(
      "https://node.poxscan.io/data/supplytrend"
    );
    return response?.data;
  } catch (error) {
    console.log("error", error);
...
export const getMarketCapTableData = async () => {
  try {
    const response = await axios.get(
      "https://node.poxscan.io/data/markettrend"
    );
    return response?.data;
  } catch (error) {
    console.log("error", error);
...
export const getPoxGeneratedTableData = async () => {
  try {
    const response = await axios.get(
      "https://node.poxscan.io/data/getgenvsburn"
    );
    return response?.data;
  } catch (error) {
    console.log("error", error);
...
export const getPoxStakedTableData = async () => {
  try {
    const response = await axios.get(
      "https://governance.poxscan.io/governance/tvlgraph"
    );
    return response?.data;
  } catch (error) {
    console.log("error", error);
...
export const getBandwidthConsumptionTableData = async () => {
  try {
    const response = await axios.get(
      "https://node.poxscan.io/data/bandwidthCons"
    );
    return response?.data;
  } catch (error) {
    console.log("error", error);
...
export const getAvgBlockSizeTableData = async () => {
  try {
    const response = await axios.get(
      "https://node.poxscan.io/data/avgBlockSize"
    );
    return response?.data;
  } catch (error) {
    console.log("error", error);
...
export const getOnChainSizeTableData = async () => {
  try {
    const response = await axios.get(
      "https://node.poxscan.io/data/onChainData"
    );
    return response?.data;
  } catch (error) {
    console.log("error", error);
...
export const getSrVoteTableData = async () => {
  try {
    const response = await axios.post(
      "https://governance.poxscan.io/governance/getWitnessData"
    );
    return response?.data;
  } catch (error) {
    console.log("error", error);
...
export const getContractCallTableData = async () => {
  try {
    const response = await axios.get(
      "https://governance.poxscan.io/token/contractCallsbyDate"
    );
    return response?.data;
  } catch (error) {
    console.log("error", error);
...
export const getTopContractTableData = async () => {
  try {
    const response = await axios.get(
      "https://governance.poxscan.io/token/topcontractbycalls"
    );
    return response?.data;
  } catch (error) {
    console.log("error", error);
...
export const getRankingAccountDayOneData = async () => {
  try {
    const response = await axios.get(
      "https://node.poxscan.io/data/TopAccounts?day=1"
    );
    return response?.data;
  } catch (error) {
    console.log("error", error);
...
export const getRankingAccountDayThreeData = async () => {
  try {
    const response = await axios.get(
      "https://node.poxscan.io/data/TopAccounts?day=3"
    );
    return response?.data;
  } catch (error) {
    console.log("error", error);
...
export const getRankingAccountDaySevenData = async () => {
  try {
    const response = await axios.get(
      "https://node.poxscan.io/data/TopAccounts?day=7"
    );
    return response?.data;
  } catch (error) {
    console.log("error", error);
...
export const getRankingTokenDayOneData = async () => {
  try {
    const response = await axios.get(
      "https://governance.poxscan.io/token/toptokens?day=1"
    );
    return response?.data;
  } catch (error) {
    console.log("error", error);
...
export const getRankingTokenDayThreeData = async () => {
  try {
    const response = await axios.get(
      "https://governance.poxscan.io/token/toptokens?day=3"
    );
    return response?.data;
  } catch (error) {
    console.log("error", error);
...
export const getRankingTokenDaySevenData = async () => {
  try {
    const response = await axios.get(
      "https://governance.poxscan.io/token/toptokens?day=7"
    );
    return response?.data;
  } catch (error) {
    console.log("error", error);
...
export const getRankingContractDayOneData = async () => {
  try {
    const response = await axios.get(
      "https://governance.poxscan.io/token/topcontractbycalls?day=1"
    );
    return response?.data;
  } catch (error) {
    console.log("error", error);
...
export const getRankingContractDayThreeData = async () => {
  try {
    const response = await axios.get(
      "https://governance.poxscan.io/token/topcontractbycalls?day=3"
    );
    return response?.data;
  } catch (error) {
    console.log("error", error);
...
export const getRankingContractDaySevenData = async () => {
  try {
    const response = await axios.get(
      "https://governance.poxscan.io/token/topcontractbycalls?day=7"
    );
    return response?.data;
  } catch (error) {
    console.log("error", error);
...
export const getUsdxOverviewData = async () => {
  try {
    const response = await axios.post(
      "https://governance.poxscan.io/token/gettoken",
      {
